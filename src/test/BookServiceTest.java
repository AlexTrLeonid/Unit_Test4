...
public class BookServiceTest {
    ...
    public void testFindBookById() {
        ...
        Book expectedBook = new Book("1", "Братья Карамазовы", "Достоевский Ф.М.");
    ...
    public void testFindAllBooks() {
        ...
        expectedBooks.add(new Book("1", "Братья Карамазовы", "Достоевский Ф.М."));
        expectedBooks.add(new Book("2", "UNIT-test", "Чехов А. П."));
